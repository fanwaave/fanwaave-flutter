...
const Set<AppCapability> requiredParityCapabilities = <AppCapability>{
  ...
  AppCapability.creatorDiscovery,
  AppCapability.eventFeed,
  AppCapability.subscriptions,
  AppCapability.engagement,
  AppCapability.pushNotifications,
  AppCapability.desktopNotifications,
  AppCapability.deepLinks,
  AppCapability.shareIntent,
...
void verifyRequiredParityCapabilities(AppPlatformAdapter adapter) {
  ...
  if (missing.isNotEmpty) {
    throw StateError(
        'Fanwaave parity gate failed for ${adapter.surface}: $missing');
  }
}
